export default {
  ...
  editor: {
    ...
    batchFirstFrame: 'Batch Generate All First Frames',
    batchFirstFrameConfirm: 'This will generate first-frame prompts and images for all storyboards that do not yet have one. Continue?',
    batchFirstFrameSubmit: 'Submitting task...',
    batchFirstFrameSuccess: 'All first-frame images generated!',
    batchFirstFrameFailed: 'Batch generation failed',
    batchFirstFrameTimeout: 'Batch generation timed out, please refresh to check results',
