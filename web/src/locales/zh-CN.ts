export default {
  ...
  editor: {
    ...
    prompt: '提示词',
    extractPrompt: '提取提示词',
    batchFirstFrame: '一键生成所有首帧图片',
    batchFirstFrameConfirm: '将为该剧集所有尚未生成首帧图片的镜头自动提取提示词并生成图片，是否继续？',
    batchFirstFrameSubmit: '提交任务中...',
    batchFirstFrameSuccess: '所有首帧图片生成完成！',
    batchFirstFrameFailed: '批量生成失败',
    batchFirstFrameTimeout: '批量生成超时，请刷新页面查看结果',
